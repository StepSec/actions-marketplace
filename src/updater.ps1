# example calls:
# .\updater.ps1 -orgName "stepsec" -userName "xxx" -PAT $env:GitHubPAT -$marketplaceRepo "stepsec/actions-marketplace"
param (
    [string] $orgName,
    [string] $userName,
    [string] $PAT,
...
function CheckAllReposInOrg {
    ...
    foreach ($repo in $repos) {
        ...
        # GET https://api.github.com/repos/stepsec/actions-testing/contents/action.yml
        ...
        if ($hasActionFile) {
            ...
            if ($repo.full_name -eq "stepsec/mutation-testing-elements") {
...
#$orgName = "stepsec"; $userName = "xxx"; $PAT = $env:GitHubPAT; $testingLocally = $true; 
#$marketplaceRepo = "stepsec/actions-marketplace"; $userEmail = "raj.bos@gmail.com"; $userName = "Rob Bos";
